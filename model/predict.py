...
tf.app.flags.DEFINE_string("img_checkpoint_path", "./data/pretrain/resnet_v2_152",
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        start = time.clock()
        image_array = load_image_array(FLAGS.image_path)
    ...
    model_options = {
        ...
        'fc7_feature_length': FLAGS.img_feat_len,
